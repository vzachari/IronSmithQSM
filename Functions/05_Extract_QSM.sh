...
paste -d "," Group_L_Accumbens_area_Mean.txt \
	...
	Group_LR_Thalamus_Proper_Mean.txt | awk -v r=$Subj '{print r","$0}' | pr -t > Group_QSM_Mean_Columns.csv

paste -d "," Group_L_Accumbens_area_ADJ.txt \
	...
	Group_LR_Thalamus_Proper_ADJ.txt | awk -v r=$Subj '{print r","$0}' | pr -t > Group_QSM_ADJ_Mean_Columns.csv
