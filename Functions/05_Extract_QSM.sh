...
singularity run -e --bind $OutFolder/Group:/mnt $Path/Functions/QSM_Container.simg \
	sort -k1 -n /mnt/${OutStatFile[$LoopCounter]} -o /mnt/${OutStatFile[$LoopCounter]}
...
singularity run -e --bind $OutFolder/Group:/mnt $Path/Functions/QSM_Container.simg \
	sort -k1 -n /mnt/${OutStatFileADJ[$LoopCounter]} -o /mnt/${OutStatFileADJ[$LoopCounter]}
